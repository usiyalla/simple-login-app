import { r as registerInstance, h, H as Host } from './index-6de32e7e.js';
...
class ImageList {
    constructor() {
        ...
        this.state = 'pending';
        this.fetchImages = flow(function* () {
            this.imageList = [];
            try {
...
__decorate([
    observable
], ImageList.prototype, "imageList", void 0);
__decorate([
    observable
], ImageList.prototype, "state", void 0);
__decorate([
    action
], ImageList.prototype, "addImage", null);
__decorate([
    computed
], ImageList.prototype, "images", null);

const imageListStore = new ImageList();

const userGalleryCss = ":host{display:block}.container{height:500px}";

const UserGallery = class {
    constructor(hostRef) {
    ...
    renderImages() {
        return this.images.map((i) => {
            console.log(i.url);
            return (h("app-image", { url: i.url }));
        });
    }
    render() {
        return (h(Host, null, h("slot", null, "Gallery"), h("stencil-route-link", { url: '/adil/gallery/1' }, h("button", null, "Image 1")), h("stencil-route-link", { url: '/adil/gallery/2' }, h("button", null, "Image 2")), h("div", null, this.renderImages())));
    }
};
UserGallery.style = userGalleryCss;

export { UserGallery as user_gallery };
